...
1. Now it's time for adding yet another package; this time a very important library that uses WebGL to render interactive maps from [vector tiles](https://docs.mapbox.com/help/glossary/vector-tiles/) and [Mapbox styles](https://maplibre.org/maplibre-gl-js-docs/style-spec/)
...
1. Copy and paste the snippet below (or download) into your  `tileserver/tilelive-aws.js` file:
